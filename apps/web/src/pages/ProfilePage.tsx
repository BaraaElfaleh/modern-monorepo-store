    ...
    <div className="bg-background text-text-main min-h-screen pb-20 animate-in fade-in duration-700">
        ...
        <div className="absolute -bottom-16 left-[6%] flex items-end gap-6">
          <div className="relative group">
            <img 
              src={user?.image} 
              alt={user?.username} 
              className="w-32 h-32 rounded-4xl border-4 border-background bg-surface-muted object-cover shadow-elevated"
            />
      ...
      <div className="px-[6%] mt-24 grid lg:grid-cols-3 gap-10">
        ...
        <div className="space-y-6">
          <div className="bg-surface/40 backdrop-blur-md border border-border/50 p-8 rounded-4xl shadow-soft">
