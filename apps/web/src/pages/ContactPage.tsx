...
export function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-background animate-in fade-in duration-1000">
      ...
      {/* Map Placeholder */}
      <div className="h-100 w-full bg-surface-muted relative grayscale opacity-60 hover:grayscale-0 transition-all duration-1000 flex items-center justify-center border-t border-border">
